//
//  PlayerContentViewController2.m
//  ApplesToApples
//
...
@interface PlayerContentViewController2()
...
@implementation PlayerContentViewController2
...
-(void)viewDidLoad
{
    ...
    NSArray *keys = [allGreenCards allKeys];
    NSString *randomKey = keys[arc4random() % [keys count]];
    self.greenSummary.text = allGreenCards[randomKey];
    self.greenTitle.text = randomKey;
