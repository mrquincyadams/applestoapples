...
#import "PlayerContentViewController2.h"

@interface ViewController ()
{
    NSDictionary *allRedCardsTitles;
    NSDictionary *allGreenCards;
}
...
- (void)viewDidLoad {
    ...
    allRedCardsTitles = @{
                                        ...
                                        @"A High School Bathroom":@"'Fools rush in where the angels fear to tread.' -Alexander Pope",
                                        ...
                                        @"A School Bus":@"'The only thing we have to fear is fear itself.' -Franklin Roosevelt",
                                        ...
                                        @"Albert Einstein":@"1879-1955, German-born American physicist and Nobel laureate who created theories of relativity.",
                                        ...
                                        @"Apples":@"More than 40 million metric tons are produced worldwide every wear. How 'bout them apples?",
                                        ...
                                        @"At My Parent's House":@"Like never-never land, you're never seen as an adult here.", @"Atlantis":@"Mythological city where the folks had that sinking feeling.",
                                        ...
                                        @"Bangkok":@"Capital of Thailand. Location: near the Gul of Siam. Population: five million. Reputation: seedy.",
                                        ...
                                        @"Bell-Bottoms":@"Bell-bottoms and pea coats - whou would have thought the Navy could be such a trendsetter?",
                                        ...
                                        @"Big Macs":@"T w o a l l b e e f p a t t i e s s p e c i a l s a u c e l e t t u c e c h e e s e p i c k l e s o n i o n s o n a s e s a m e s e e d bun .",
                                        ...
                                        @"Bill Gates":@"1955-, chairman and chief software archictect of Microsoft Corportion. A very rich guy.", @"Bill Murray":@"1950-, American actor and comedian. Star of Ghostbusters, Stripes, Groundhog Day, and Lost in Translation.",
                                        ...
                                        @"Car Horns":@"Blow it, buddy!", @"Carl Sagan":@"1934-96, American astronomer and pioneer exobiologist. Touched many lives. Billions and billions of them.",
                                        ...
                                        @"Challenger Explosion":@"'Without a wish, without a will / I stood upon that silent hilll / and stared into the sky...' -Ralph Hodgeson",
                                        ...
                                        @"Cheescake":@"A really tasty dish.",
                                        @"Cher":@"1946-, American siner and actor, she makes aging look good.",
                                        ...
                                        @"China":@"The most populous country in the world. More than one-fifth of the world's total population lives whtin its borders.",
                                        ...
                                        @"Coconuts":@"'Put the lime in the coconut, and drank them both up.",
                                        ...
                                        @"Corn On The Comb":@"A grain native to the Americas, corn was a staple food for many centuries before corn holders were invented.",
                                        @"Corvettes":@"In 1953, Chevrolet introduced the Corvette, the first mass-produced sports car with a fiberglass body.",
                                        ...
                                        @"Cow-Pies":@"When dired, these 'cow chips' are hurled discus-like over great distances.",
                                        ...
                                        @"Cuba":@"island republic in the Caribbean, just south of Florida. Beans and rice never tased so good.",
                                        ...
                                        @"Democrats":@"Theyr symbol is the donkey, or ass. Insert your own joke here.",
                                        ...
                                        @"Earthquakes":@"The Richter scale is named after hte American seismologist Charles Richter. Did the earth move for you?",
                                        ...
                                        @"Firefighters":@"Emperor Augustus instituted a corps of fire-fighting 'watchmen' in 24 BC. Nero, on the other hand, fiddled while Rome burned.",
                                        ...
                                        @"Fort Knox":@"American military post in Kentucky, containing hte greater part of the gold rserve of the U.S. government.",
                                        ...
                                        @"Funerals":@"'He who dies with the most toys is, nonethelesss, still dead.' -Anonymous",
                                        ...
                                        @"Garrion Keillor":@"1942-, American author and radio star. He shares the Midwest perspective with 2.6 million listeners each week on A Prairie Home Companion.",
                                        @"Garth Brooks":@"1962-, American country music singer and songwriter. He's got friends in low places.",
                                        @"Geishas":@"Japanese women training in traditional singing, dancing, and entertaining. Of course, you would never recognize them without all that makeup.",
                                        @"Gen. George S. Patton":@"1885-1945, the commander of the American Third Army during World War II. -a.k.a. Of Blood and Guts",
                                        @"Genetic Engineering":@"What DO you get when ou cross a monkey with a potato?",
                                        ...
                                        @"George Washington":@"1732-99, First President of the United States. He chopped don a cherry tree to make false teeth, or something like that...",
                                        ...
                                        @"Giant Squid":@"Going fishing for a giant squid? Nautilus I have to...",
                                        @"Gila Monsters":@"The largest, and only poisonours lizard found in the United States.",
                                        ...
                                        @"Giving a Hug":@"'One may give without loving; bu none can love without giving.' -Anonymous",
                                        @"Glaciers":@"It'll be a codl day when we see THEM again...",
                                        ...
                                        @"Gym Teachers":@"'Iam a Physical Education Teacher. Call me a gym teacher again and you can drop and give me ten!'",
                                        @"Hair Transplants":@"Oh, it looks so natural...",
                                        @"Hairballs":@"Cough it up, kitty...",
                                        @"Halloween":@"October 31, the eve of All Saints' Day, celebrated with costumes, treats, and scary stuff. Not just for kids anymore!",
                                        ...
                                        @"Hiccups":@"How do you, hic, get 'em? How do you, hic, ge rid of 'em?",
                                        ...
                                        @"Hiroshima - 1945":@"'I am become death, the destroyer of worlds.' -J. Robert Oppenheimer, on the detonation of the first atomic bomb.",
                                        @"HMOs":@"Health Maintenance Organizations. Here's to your health...",
                                        @"Hockey":@"Did you hear about the big fight last night? All of a sudden, a hockey game broke out!",
                                        @"Hollywood":@"Motion picture and television industry center of the world. Hoory for Hollywood!",
                                        ...
                                        @"Icebergs":@"May reach 300 to 500 feet above the ocean's surface. Ask the captain of the Titanic about the 90 percent that's UNDER water.",
                                        ...
                                        @"Indiana Jones":@"Fictional archeologist and action hero. Proof that good hat and a whip can take you a long way.",
                                        @"Industrial Revolution":@"The first Industrial Revolution occurred in Great Britain at the end of he 1700s. The second came with the invention of the 'Clapper.'",
                                        ...
                                        @"Israel":@"Located on the Mediterranean, the state of Israel was created by a 1948 U.N. mandate.",
                                        ...
                                        @"Jelly Beans":@"Well, as long as we HAVE to eat ou vegetables...",
                                        ...
                                        @"Jesse Ventura":@"1951-, wrestler, Navy Seal, and former governer of Minnesota. Author of I Ain't Got Time To Bleed.",
    ...
    allGreenCards = @{
                  ...
                  @"Animated" : @"lively, exuberent, spirited",
                  ...
                  @"Dainty" : @"delicate, tender, elegant",
                  @"Dangerous" : @"risky, chancy, hazordous",
                  ...
                  @"Eccentric" : @"peculiar, odd, bizzare",
                  ...
                  @"Firtatious" : @"brazen, saucy, forward",
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        NSArray *greenKeys = [allGreenCards allKeys];
        NSMutableArray *greenCards = [[NSMutableArray alloc] init];
        NSString *randomKey = greenKeys[arc4random() % [greenKeys count]];
        [greenCards addObject:randomKey];
        PlayerContentViewController2 *dest = segue.destinationViewController;
        dest.greenCardsText = greenCards;
    }
